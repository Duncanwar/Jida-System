    ...
    <main className="jida-shell">
      ...
      <section className="jida-home-hero">
        <div className="jida-home-hero-copy">
          <p className="jida-home-hero-eyebrow">Journal of Inter-Discourse Academia</p>
          <h2>
            Advancing <span>scholarship</span> across disciplines
          </h2>
          <p>
            A peer-reviewed digital platform for manuscript submission, structured editorial
            review, revision tracking, and publication — built for authors, reviewers, and editors.
          </p>
          ...
          <div className="jida-contact-info-card">
            ...
            <div className="jida-contact-item">
              ...
              <div>
                ...
                <p><b>Submissions:</b> submissions@jida.ac.rw</p>
                <p><b>Editorial:</b> editor@jida.ac.rw</p>
                <p><b>General:</b> info@jida.ac.rw</p>
              </div>
            </div>
          </div>
      ...
      <footer className="jida-footer">
        <span>© {new Date().getFullYear()} Journal of Inter-Discourse Academia. All Rights Reserved.</span>
      </footer>
    </main>
  );
}
